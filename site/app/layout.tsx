...
export const metadata: Metadata = {
  ...
  description:
    "FehlerFix erkennt Rechtschreibfehler direkt aus der Handschrift auf dem iPad und erklärt die Regel dahinter – statt nur rot anzustreichen. Jetzt abonnieren.",
