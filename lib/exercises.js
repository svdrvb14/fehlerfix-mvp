...
const TYPES = [
  ...
  },
  {
    ...
    suits: ALWAYS,
    spec:
      'BILDERSÄTZE: Lies zusätzlich lib/imagelibrary.js – dort steht der vollständige Katalog ' +
      'verfügbarer Bild-Konzepte (Schlüssel + Kategorie). Wähle 3-5 Konzepte AUSSCHLIESSLICH aus ' +
      'diesem Katalog, deren deutsches Wort das Fokus-Feature enthält (z.B. "loewe" für ie/i). ' +
      'ERFINDE NIEMALS einen eigenen Schlüssel, der nicht im Katalog steht – gibt es kein ' +
      'passendes Konzept, wähle stattdessen ein anderes quellfähiges Format.\n' +
      'Zu jedem gewählten Bild schreibt der Lerner EINEN vollständigen Satz, der das abgebildete ' +
      'Wort enthält und im Fokus-Feature richtig schreibt. Die Aufgabenstellung darf NIE das Wort ' +
      'selbst nennen – nur "zu jedem Bild".\n' +
      'displayText bleibt LEER – die Bilder werden separat über das Feld "pictures" angezeigt.\n' +
      'Liefere ein Feld "pictures": [ { "key": "<Schlüssel exakt aus lib/imagelibrary.js>" } ].\n' +
      'correctText = je Zeile ein Beispielsatz zum jeweiligen Bild in derselben Reihenfolge wie ' +
      '"pictures" (mehrere Lösungen möglich – das bei der Bewertung berücksichtigen).\n' +
      'instruction-Beispiel: "Schreib zu jedem Bild einen ganzen Satz."',
  },
  {
    id: 'letter_grid',
